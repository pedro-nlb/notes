...
\begin{defn}
	...
	\item $X$ is (locally) rigid iff for all deformations $f\colon (\calX,X)\to (S,0)$ there exists $0\in U\sub S$ open such that for all $t\in U$ we have $\calX_{t}\cong X$, where $\cong$ means biholomorphic.
