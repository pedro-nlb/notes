...
The notation will probably not be coherent, but I tend to use bold for categories (e.g. $\Set$) and mathscr for sheaves (e.g. $\F$).
...
\section{[CM] Analytic Rings (Johan) - 2.12.19}
...
\section{[WS] Derived Cats 2 (Luca) - Introduction to Derived Categories - 4.12.19}
