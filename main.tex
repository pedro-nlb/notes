...
\begin{nota}
    ...
    \begin{center}
	\begin{tikzcd}
	    p^{-1}(\tau)\arrow{d} \arrow[hook]{r} & \tilde{X} \arrow{d}{p} & \tilde{X}\setminus p^{-1}(\tau) \arrow{d}{\sim}\arrow[hook]{l} \\
	    Z_{0}:= X\cap A\arrow[hook]{r} & X & X\setminus Z \arrow[hook]{l}
	\end{tikzcd}
    \end{center}
    \begin{center}
	\begin{tikzcd}
	    Z\arrow[hook]{r}{h_{0}} & X_{0}\arrow[hook]{r}{i_{0}} & X \\
	    & & X\setminus Z\arrow[hook]{u} \\
	    & & X\setminus X_{0}\arrow[hook]{u}
	\end{tikzcd}
    \end{center}
\end{nota}
