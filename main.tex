...
\begin{proof}[Proof of Step 2]
    ...
    At every step $\alpha$,
    \[ g|_{k_{\alpha}}=\chi|_{k_{\alpha}}(h_{1}_{\alpha},h_{2}_{\alpha})\cdot \chi(h_{3}_{\alpha},h_{4}_{\alpha})^{-1}. \]
    ...
    \begin{center}
	\begin{tikzcd}
	    & k_{\alpha}\arrow{dl}{\chi|_{k_{\alpha}}(h_{3}_{\alpha},h_{4}_{\alpha})}\arrow{dr}{\chi|_{k_{\alpha}}(h_{1}_{\alpha},h_{2}_{\alpha})} & \\
